...
class TestClientServerCommands(unittest.TestCase):
    ...
    def test_1_addmon(self):
        ...
        self.assertEqual(response, 'TESTING added monster kiss to (0, 1) saying hi hi with 10 hps')
...
kiss died'''
    ...
    def test_5_ru_attack(self):
        ...
        ans = 'TESTING добавил монстра kiss в клетку (0, 1), говорящего hi! all имеющего 21 oчко здоровья'
        self.assertEqual(response, ans)
